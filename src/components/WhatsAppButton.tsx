      ...
      {visible && (
        ...
        >
          ...
          <svg viewBox="0 0 24 24" className="w-7 h-7 fill-white relative z-10">
            ...
            <path d="M12 0C5.373 0 0 5.373 0 12c0 2.124.558 4.117 1.534 5.847L.057 23.571a.75.75 0 0 0 .921.921l5.763-1.484A11.945 11.945 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.73 9.73 0 0 1-4.964-1.355l-.355-.213-3.42.881.896-3.35-.232-.368A9.715 9.715 0 0 1 2.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z" />
          </svg>
        </motion.a>
      )}
    </AnimatePresence>
